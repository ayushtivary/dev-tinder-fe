...
const Login = () => {
    ...
    const handleSignin = (event) => {
        setLogin(event)
        setSuccessMessage("") // Reset success message when switching between login and signup
    }
    ...
    const handleSignUp = async () => {
        try {
            ...
            setLogin(true)
            setSuccessMessage("User registered successfully!") // Set success message after successful signup
    ...
    return (
        <div className="flex justify-center min-h-screen bg-gradient-to-br from-gray-900 via-indigo-950 to-purple-950">
            <div className="card w-96 bg-gray-800 shadow-2xl m-8 rounded-2xl transition-all duration-300 hover:shadow-[0_0_15px_rgba(99,102,241,0.5)]" data-theme="dark">
                <div className="card-body items-center text-center p-8">
                    <h2 className="card-title text-3xl font-bold text-white mb-6">
                        {login ? 'Welcome Back!' : 'Join Us!'}
                    </h2>

                    {/* Show success message when user successfully signs up */}
                    {successMessage && (
